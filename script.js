...
// Starting address for deliveries — centralised constant so it's easy to update
// Using a place name so Google Maps can resolve it (business/place)
const START_ADDRESS = 'Harvey Norman Melton';
...
document.getElementById('deliveryForm').addEventListener('submit', function(event) {
    ...
    console.log('Form submit — origin:', START_ADDRESS, 'destination:', customerLocation);
    calculateAndDisplayRoute(START_ADDRESS, customerLocation);
...
function calculateDistance(customerLocation) {
    console.log('DistanceMatrix request — origins:', [START_ADDRESS], 'destinations:', [customerLocation]);
...
function calculateAndDisplayRoute(origin, destination) {
    console.log('calculateAndDisplayRoute called with origin:', origin, 'destination:', destination);
